...
namespace PTV.Developer.Clients.routeoptimization.optiflow.Model
{
    ...
    public partial class RouteOptimizationVehicleCosts : IValidatableObject
    {
        ...
        /// <param name="overtimes">A list of overtime costs that describe an increasing cost if the route duration exceeds a threshold. For each exceeded threshold, the additional cost for the extra hours contributes to the total cost of the route..</param>
        /// <param name="overdistances">A list of overdistance costs that describe an increasing cost if the total distance of a route exceeds a threshold. For each exceeded threshold, the additional cost for the extra kilometers contributes to the total cost of the route..</param>
        /// <param name="overstops">A list of overstop costs that describe an increasing cost if the number of stops of a route exceeds a threshold. For each exceeded threshold, the additional cost for the extra stops contributes to the total cost of the route..</param>
        ...
        /// </summary>
        /// <value>A list of overtime costs that describe an increasing cost if the route duration exceeds a threshold. For each exceeded threshold, the additional cost for the extra hours contributes to the total cost of the route.</value>
        ...
        /// </summary>
        /// <value>A list of overdistance costs that describe an increasing cost if the total distance of a route exceeds a threshold. For each exceeded threshold, the additional cost for the extra kilometers contributes to the total cost of the route.</value>
        ...
        /// </summary>
        /// <value>A list of overstop costs that describe an increasing cost if the number of stops of a route exceeds a threshold. For each exceeded threshold, the additional cost for the extra stops contributes to the total cost of the route.</value>
