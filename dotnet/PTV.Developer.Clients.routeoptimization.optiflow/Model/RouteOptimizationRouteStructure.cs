...
namespace PTV.Developer.Clients.routeoptimization.optiflow.Model
{
    ...
    public partial class RouteOptimizationRouteStructure : IValidatableObject
    {
        ...
        /// <param name="resources">A description of the assigned resources that can be used to reconstruct the route..</param>
        /// <param name="resourceIds">**Deprecated: use resources instead.** The unique identifiers of the resources assigned to the vehicle executing the route..</param>
        ...
        /// <param name="reconstructionPolicy">reconstructionPolicy.</param>
        public RouteOptimizationRouteStructure(string vehicleId = default(string), List<RouteOptimizationAssignedResourceStructure> resources = default(List<RouteOptimizationAssignedResourceStructure>), List<string> resourceIds = default(List<string>), DateTimeOffset? start = default(DateTimeOffset?), string startLocationId = default(string), string endLocationId = default(string), List<RouteOptimizationTaskStructure> tasks = default(List<RouteOptimizationTaskStructure>), List<RouteOptimizationBreakStructure> breaks = default(List<RouteOptimizationBreakStructure>), List<RouteOptimizationChargingStructure> charging = default(List<RouteOptimizationChargingStructure>), RouteOptimizationRouteReconstructionPolicy reconstructionPolicy = default(RouteOptimizationRouteReconstructionPolicy))
        {
        ...
        /// </summary>
        /// <value>A description of the assigned resources that can be used to reconstruct the route.</value>
        [DataMember(Name = "resources", EmitDefaultValue = false)]
        public List<RouteOptimizationAssignedResourceStructure> Resources { get; set; }

        /// <summary>
        /// **Deprecated: use resources instead.** The unique identifiers of the resources assigned to the vehicle executing the route.
        /// </summary>
        /// <value>**Deprecated: use resources instead.** The unique identifiers of the resources assigned to the vehicle executing the route.</value>
        ...
        /// <summary>
        /// Gets or Sets ReconstructionPolicy
        /// </summary>
        [DataMember(Name = "reconstructionPolicy", EmitDefaultValue = false)]
        public RouteOptimizationRouteReconstructionPolicy ReconstructionPolicy { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  ReconstructionPolicy: ").Append(ReconstructionPolicy).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            if (this.VehicleId != null && this.VehicleId.Length > 200)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for VehicleId, length must be less than 200.", new [] { "VehicleId" });
            }
            ...
            if (this.VehicleId != null) {
                ...
                Regex regexVehicleId = new Regex(@"^[a-zA-Z0-9_-]{1,200}$", RegexOptions.CultureInvariant);
            ...
            if (this.StartLocationId != null && this.StartLocationId.Length > 200)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for StartLocationId, length must be less than 200.", new [] { "StartLocationId" });
            }
            ...
            if (this.StartLocationId != null) {
                ...
                Regex regexStartLocationId = new Regex(@"^[a-zA-Z0-9_-]{1,200}$", RegexOptions.CultureInvariant);
            ...
            if (this.EndLocationId != null && this.EndLocationId.Length > 200)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for EndLocationId, length must be less than 200.", new [] { "EndLocationId" });
            }
            ...
            if (this.EndLocationId != null) {
                ...
                Regex regexEndLocationId = new Regex(@"^[a-zA-Z0-9_-]{1,200}$", RegexOptions.CultureInvariant);
