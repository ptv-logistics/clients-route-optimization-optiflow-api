...
namespace PTV.Developer.Clients.routeoptimization.optiflow.Model
{
    ...
    public partial class RouteOptimizationRouteStructure : IValidatableObject
    {
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            if (this.VehicleId != null && this.VehicleId.Length > 50)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for VehicleId, length must be less than 50.", new [] { "VehicleId" });
            }
            ...
            if (this.VehicleId != null) {
                ...
                Regex regexVehicleId = new Regex(@"^[a-zA-Z0-9_-]{1,50}$", RegexOptions.CultureInvariant);
