...
namespace PTV.Developer.Clients.routeoptimization.optiflow.Model
{
    ...
    public partial class RouteOptimizationRouteStructure : IValidatableObject
    {
        ...
        public RouteOptimizationRouteStructure(string vehicleId = default(string), List<string> resourceIds = default(List<string>), DateTimeOffset? start = default(DateTimeOffset?), List<RouteOptimizationTaskStructure> tasks = default(List<RouteOptimizationTaskStructure>), List<RouteOptimizationBreakStructure> breaks = default(List<RouteOptimizationBreakStructure>), List<RouteOptimizationChargingStructure> charging = default(List<RouteOptimizationChargingStructure>))
        {
