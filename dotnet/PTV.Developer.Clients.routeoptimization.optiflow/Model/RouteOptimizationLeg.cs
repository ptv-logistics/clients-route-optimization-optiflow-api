...
namespace PTV.Developer.Clients.routeoptimization.optiflow.Model
{
    ...
    public partial class RouteOptimizationLeg : IValidatableObject
    {
        ...
        public RouteOptimizationLeg(string startLocationId = default(string), DateTimeOffset? departure = default(DateTimeOffset?), string endLocationId = default(string), DateTimeOffset? arrival = default(DateTimeOffset?), List<RouteOptimizationBreak> breaks = default(List<RouteOptimizationBreak>), int? distance = default(int?), int? drivingDuration = default(int?), List<RouteOptimizationLegLoad> loads = default(List<RouteOptimizationLegLoad>))
        {
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            if (this.StartLocationId != null && this.StartLocationId.Length > 50)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for StartLocationId, length must be less than 50.", new [] { "StartLocationId" });
            }
            ...
            if (this.StartLocationId != null) {
                ...
                Regex regexStartLocationId = new Regex(@"^[a-zA-Z0-9_-]{1,50}$", RegexOptions.CultureInvariant);
            ...
            if (this.EndLocationId != null && this.EndLocationId.Length > 50)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for EndLocationId, length must be less than 50.", new [] { "EndLocationId" });
            }
            ...
            if (this.EndLocationId != null) {
                ...
                Regex regexEndLocationId = new Regex(@"^[a-zA-Z0-9_-]{1,50}$", RegexOptions.CultureInvariant);
