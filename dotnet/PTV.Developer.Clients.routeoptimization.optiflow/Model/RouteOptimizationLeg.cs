...
namespace PTV.Developer.Clients.routeoptimization.optiflow.Model
{
    ...
    public partial class RouteOptimizationLeg : IValidatableObject
    {
        ...
        /// <param name="loads">A list of used capacities of the vehicle..</param>
        /// <param name="stateOfCharge">stateOfCharge.</param>
        public RouteOptimizationLeg(string startLocationId = default(string), DateTimeOffset? departure = default(DateTimeOffset?), string endLocationId = default(string), DateTimeOffset? arrival = default(DateTimeOffset?), List<RouteOptimizationBreak> breaks = default(List<RouteOptimizationBreak>), int? distance = default(int?), int? drivingDuration = default(int?), List<RouteOptimizationLegLoad> loads = default(List<RouteOptimizationLegLoad>), RouteOptimizationLegStateOfCharge stateOfCharge = default(RouteOptimizationLegStateOfCharge))
        {
        ...
        /// </summary>
        /// <value>A list of used capacities of the vehicle.</value>
        [DataMember(Name = "loads", EmitDefaultValue = false)]
        public List<RouteOptimizationLegLoad> Loads { get; set; }

        /// <summary>
        /// Gets or Sets StateOfCharge
        /// </summary>
        [DataMember(Name = "stateOfCharge", EmitDefaultValue = false)]
        public RouteOptimizationLegStateOfCharge StateOfCharge { get; set; }
