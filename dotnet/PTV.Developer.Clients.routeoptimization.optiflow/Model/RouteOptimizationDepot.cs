...
namespace PTV.Developer.Clients.routeoptimization.optiflow.Model
{
    ...
    public partial class RouteOptimizationDepot : IValidatableObject
    {
        ...
        public RouteOptimizationDepot(string id = default(string), string locationId = default(string), List<string> timeSlotIds = default(List<string>), List<string> categories = default(List<string>), RouteOptimizationDepotCosts costs = default(RouteOptimizationDepotCosts), RouteOptimizationDepotConstraints constraints = default(RouteOptimizationDepotConstraints))
        {
        ...
        public RouteOptimizationDepotCosts Costs { get; set; }

        /// <summary>
        /// Gets or Sets Constraints
        /// </summary>
        [DataMember(Name = "constraints", EmitDefaultValue = false)]
        public RouteOptimizationDepotConstraints Constraints { get; set; }
