...
namespace PTV.Developer.Clients.routeoptimization.optiflow.Model
{
    ...
    public partial class RouteOptimizationDepot : IValidatableObject
    {
        ...
        public RouteOptimizationDepot(string id = default(string), string locationId = default(string), List<string> timeSlotIds = default(List<string>), List<string> categories = default(List<string>), RouteOptimizationDepotConstraints constraints = default(RouteOptimizationDepotConstraints))
        {
