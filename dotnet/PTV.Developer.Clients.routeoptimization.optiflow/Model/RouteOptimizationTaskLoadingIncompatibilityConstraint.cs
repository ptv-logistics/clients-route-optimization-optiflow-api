...
namespace PTV.Developer.Clients.routeoptimization.optiflow.Model
{
    ...
    public partial class RouteOptimizationTaskLoadingIncompatibilityConstraint : IValidatableObject
    {
        ...
        /// <param name="forbiddenTaskCategory">Tasks belonging to this category cannot be executed while the constraint applies. The constraint will be ignored when no task belongs to this category. (required).</param>
        ...
        /// </summary>
        /// <value>Tasks belonging to this category cannot be executed while the constraint applies. The constraint will be ignored when no task belongs to this category.</value>
