...
namespace PTV.Developer.Clients.routeoptimization.optiflow.Model
{
    ...
    public partial class RouteOptimizationOrderProperties : IValidatableObject
    {
        ...
        public RouteOptimizationOrderProperties(List<RouteOptimizationLoad> loads = default(List<RouteOptimizationLoad>), int? repositioningEffort = 0, double? outsourcingCost = default(double?), double? insourcingRevenue = default(double?), List<string> categories = default(List<string>))
        {
            this.Loads = loads;
