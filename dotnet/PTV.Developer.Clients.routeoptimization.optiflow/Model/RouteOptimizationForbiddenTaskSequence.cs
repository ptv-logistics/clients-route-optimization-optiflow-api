...
namespace PTV.Developer.Clients.routeoptimization.optiflow.Model
{
    ...
    public partial class RouteOptimizationForbiddenTaskSequence : IValidatableObject
    {
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            if (this.FirstTaskCategory != null && this.FirstTaskCategory.Length > 200)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for FirstTaskCategory, length must be less than 200.", new [] { "FirstTaskCategory" });
            }
            ...
            if (this.FirstTaskCategory != null) {
                ...
                Regex regexFirstTaskCategory = new Regex(@"^[a-zA-Z0-9_-]{1,200}$", RegexOptions.CultureInvariant);
            ...
            if (this.SecondTaskCategory != null && this.SecondTaskCategory.Length > 200)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for SecondTaskCategory, length must be less than 200.", new [] { "SecondTaskCategory" });
            }
            ...
            if (this.SecondTaskCategory != null) {
                ...
                Regex regexSecondTaskCategory = new Regex(@"^[a-zA-Z0-9_-]{1,200}$", RegexOptions.CultureInvariant);
