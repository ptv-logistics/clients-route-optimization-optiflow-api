...
namespace PTV.Developer.Clients.routeoptimization.optiflow.Model
{
    ...
    public partial class RouteOptimizationForbiddenTaskSequence : IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="RouteOptimizationForbiddenTaskSequence" /> class.
        /// </summary>
        /// <param name="firstTaskCategory">The category of tasks that cannot be scheduled on the route before a task with the second task category. The constraint will be ignored if no task belongs to this category. (required).</param>
        /// <param name="type">type (required).</param>
        /// <param name="secondTaskCategory">The category of the tasks that must not be preceded in the route by tasks belonging to the first task category. The constraint will be ignored if no task belongs to this category. (required).</param>
        ...
        /// <summary>
        /// The category of tasks that cannot be scheduled on the route before a task with the second task category. The constraint will be ignored if no task belongs to this category.
        /// </summary>
        /// <value>The category of tasks that cannot be scheduled on the route before a task with the second task category. The constraint will be ignored if no task belongs to this category.</value>
        ...
        /// <summary>
        /// The category of the tasks that must not be preceded in the route by tasks belonging to the first task category. The constraint will be ignored if no task belongs to this category.
        /// </summary>
        /// <value>The category of the tasks that must not be preceded in the route by tasks belonging to the first task category. The constraint will be ignored if no task belongs to this category.</value>
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            if (this.FirstTaskCategory != null && this.FirstTaskCategory.Length > 50)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for FirstTaskCategory, length must be less than 50.", new [] { "FirstTaskCategory" });
            }
            ...
            if (this.FirstTaskCategory != null) {
                ...
                Regex regexFirstTaskCategory = new Regex(@"^[a-zA-Z0-9_-]{1,50}$", RegexOptions.CultureInvariant);
            ...
            if (this.SecondTaskCategory != null && this.SecondTaskCategory.Length > 50)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for SecondTaskCategory, length must be less than 50.", new [] { "SecondTaskCategory" });
            }
            ...
            if (this.SecondTaskCategory != null) {
                ...
                Regex regexSecondTaskCategory = new Regex(@"^[a-zA-Z0-9_-]{1,50}$", RegexOptions.CultureInvariant);
