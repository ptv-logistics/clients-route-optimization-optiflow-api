...
namespace PTV.Developer.Clients.routeoptimization.optiflow.Model
{
    ...
    public partial class RouteOptimizationMetrics : IValidatableObject
    {
        ...
        public RouteOptimizationMetrics(int? numberOfUnscheduledOrders = default(int?), int? numberOfRoutes = default(int?), int? numberOfResources = default(int?), double? totalCost = default(double?), long? totalDistance = default(long?), long? totalDuration = default(long?))
        {
