...
namespace PTV.Developer.Clients.routeoptimization.optiflow.Model
{
    ...
    public partial class RouteOptimizationMetrics : IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="RouteOptimizationMetrics" /> class.
        /// </summary>
        /// <param name="numberOfScheduledOrders">The number of orders that are scheduled by the optimization. (required).</param>
        /// <param name="numberOfUnscheduledOrders">The number of orders that are not scheduled by the optimization. (required).</param>
        ...
        /// <param name="totalCost">The total cost of the scheduled routes. This includes the cost of the routes and the outsourcing cost of the  unscheduled orders..</param>
        ...
        /// <summary>
        /// The number of orders that are scheduled by the optimization.
        /// </summary>
        /// <value>The number of orders that are scheduled by the optimization.</value>
        /// <example>0</example>
        [DataMember(Name = "numberOfScheduledOrders", IsRequired = true, EmitDefaultValue = true)]
        public int? NumberOfScheduledOrders { get; set; }

        /// <summary>
        /// The number of orders that are not scheduled by the optimization.
        /// </summary>
        /// <value>The number of orders that are not scheduled by the optimization.</value>
        /// <example>0</example>
        ...
        /// <summary>
        /// The total cost of the scheduled routes. This includes the cost of the routes and the outsourcing cost of the  unscheduled orders.
        /// </summary>
        /// <value>The total cost of the scheduled routes. This includes the cost of the routes and the outsourcing cost of the  unscheduled orders.</value>
