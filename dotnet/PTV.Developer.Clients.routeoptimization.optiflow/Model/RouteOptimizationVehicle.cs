...
namespace PTV.Developer.Clients.routeoptimization.optiflow.Model
{
    ...
    public partial class RouteOptimizationVehicle : IValidatableObject
    {
        ...
        /// <param name="requiredResourceCategories">A list of resource categories specifying the resources required by the vehicle. For each category in this list exactly one matching resource will be assigned to the vehicle..</param>
        ...
        public RouteOptimizationVehicle(string id = default(string), RouteOptimizationVehicleStart start = default(RouteOptimizationVehicleStart), RouteOptimizationVehicleEnd end = default(RouteOptimizationVehicleEnd), RouteOptimizationVehicleRouting routing = default(RouteOptimizationVehicleRouting), RouteOptimizationVehicleBattery battery = default(RouteOptimizationVehicleBattery), List<string> requiredResourceCategories = default(List<string>), RouteOptimizationVehicleCosts costs = default(RouteOptimizationVehicleCosts), RouteOptimizationVehiclePreferences preferences = default(RouteOptimizationVehiclePreferences), RouteOptimizationBreakSettings breaks = default(RouteOptimizationBreakSettings), List<RouteOptimizationCompartment> compartments = default(List<RouteOptimizationCompartment>), RouteOptimizationVehicleConstraints constraints = default(RouteOptimizationVehicleConstraints), List<string> categories = default(List<string>))
        {
        ...
        public RouteOptimizationVehicleBattery Battery { get; set; }
        ...
        /// </summary>
        /// <value>A list of resource categories specifying the resources required by the vehicle. For each category in this list exactly one matching resource will be assigned to the vehicle.</value>
        /// <example>[&quot;DRIVER&quot;]</example>
        [DataMember(Name = "requiredResourceCategories", EmitDefaultValue = false)]
        public List<string> RequiredResourceCategories { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  RequiredResourceCategories: ").Append(RequiredResourceCategories).Append("\n");
