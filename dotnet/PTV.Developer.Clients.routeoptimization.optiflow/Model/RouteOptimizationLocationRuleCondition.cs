...
namespace PTV.Developer.Clients.routeoptimization.optiflow.Model
{
    ...
    public partial class RouteOptimizationLocationRuleCondition : IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="locationCategory">The rule applies only to locations whose categories match this condition. When omitted, the rule applies to all locations. If this field contains a plain category name (e.g. &#x60;CATEGORY_A&#x60;), it matches locations that have this category. If this field starts with &#x60;!&#x60; (e.g. &#x60;!CATEGORY_A&#x60;), it matches locations that **do not** have that category. If no location matches this condition, the rule is ignored..</param>
        /// <param name="previousLocationCategory">The rule applies only if the categories of the previous location in the route match this condition. When omitted, the rule applies independently of the previous location. If this field contains a plain category name (e.g. &#x60;CATEGORY_A&#x60;), it matches locations that have this category. If this field starts with &#x60;!&#x60; (e.g. &#x60;!CATEGORY_A&#x60;), it matches locations that **do not** have that category. If no location matches this condition, the rule is ignored..</param>
        ...
        /// </summary>
        /// <value>The rule applies only to locations whose categories match this condition. When omitted, the rule applies to all locations. If this field contains a plain category name (e.g. &#x60;CATEGORY_A&#x60;), it matches locations that have this category. If this field starts with &#x60;!&#x60; (e.g. &#x60;!CATEGORY_A&#x60;), it matches locations that **do not** have that category. If no location matches this condition, the rule is ignored.</value>
        ...
        /// </summary>
        /// <value>The rule applies only if the categories of the previous location in the route match this condition. When omitted, the rule applies independently of the previous location. If this field contains a plain category name (e.g. &#x60;CATEGORY_A&#x60;), it matches locations that have this category. If this field starts with &#x60;!&#x60; (e.g. &#x60;!CATEGORY_A&#x60;), it matches locations that **do not** have that category. If no location matches this condition, the rule is ignored.</value>
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            if (this.LocationCategory != null && this.LocationCategory.Length > 51)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for LocationCategory, length must be less than 51.", new [] { "LocationCategory" });
            }
            ...
            if (this.LocationCategory != null) {
                ...
                Regex regexLocationCategory = new Regex(@"^!?[a-zA-Z0-9_-]{1,50}$", RegexOptions.CultureInvariant);
            ...
            if (this.PreviousLocationCategory != null && this.PreviousLocationCategory.Length > 51)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for PreviousLocationCategory, length must be less than 51.", new [] { "PreviousLocationCategory" });
            }
            ...
            if (this.PreviousLocationCategory != null) {
                ...
                Regex regexPreviousLocationCategory = new Regex(@"^!?[a-zA-Z0-9_-]{1,50}$", RegexOptions.CultureInvariant);
