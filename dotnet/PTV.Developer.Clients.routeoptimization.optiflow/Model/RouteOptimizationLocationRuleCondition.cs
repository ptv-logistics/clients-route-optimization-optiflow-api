...
namespace PTV.Developer.Clients.routeoptimization.optiflow.Model
{
    ...
    public partial class RouteOptimizationLocationRuleCondition : IValidatableObject
    {
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            if (this.LocationCategory != null && this.LocationCategory.Length > 37)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for LocationCategory, length must be less than 37.", new [] { "LocationCategory" });
            }
            ...
            if (this.PreviousLocationCategory != null && this.PreviousLocationCategory.Length > 37)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for PreviousLocationCategory, length must be less than 37.", new [] { "PreviousLocationCategory" });
            }
