...
namespace PTV.Developer.Clients.routeoptimization.optiflow.Model
{
    ...
    public partial class RouteOptimizationTimeSlotRuleCondition : IValidatableObject
    {
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            if (this.TimeSlotCategory != null && this.TimeSlotCategory.Length > 201)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for TimeSlotCategory, length must be less than 201.", new [] { "TimeSlotCategory" });
            }
            ...
            if (this.TimeSlotCategory != null) {
                ...
                Regex regexTimeSlotCategory = new Regex(@"^!?[a-zA-Z0-9_-]{1,200}$", RegexOptions.CultureInvariant);
