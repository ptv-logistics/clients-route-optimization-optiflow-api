...
namespace PTV.Developer.Clients.routeoptimization.optiflow.Model
{
    ...
    public partial class RouteOptimizationVehicleStart : IValidatableObject
    {
        ...
        /// </summary>
        /// <value>The sequence in which the vehicle was loaded with orders. Their pickup task must not be provided and will be planned at the vehicle&#39;s start. As a result, features dependent on pickup tasks - such as task constraints or stop concurrency - will not apply. Constraints independent of pickup tasks will still be enforced (e.g., maximum loads, compartments, repositioning effort, or order sequences). If there are loaded orders, the location id of the start must be defined. Note that a loaded order may remain unscheduled if it is infeasible or better in terms of cost to exclude it. In this case, the unscheduled loaded order will also not be considered for any constraints. Check your individual price plan or contract to see whether or not the request may contain loaded orders.</value>
        [DataMember(Name = "loadedOrders", EmitDefaultValue = false)]
        public List<RouteOptimizationLoadedOrder> LoadedOrders { get; set; }
