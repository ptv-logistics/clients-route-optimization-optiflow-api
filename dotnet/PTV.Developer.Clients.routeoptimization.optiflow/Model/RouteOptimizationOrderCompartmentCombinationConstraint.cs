...
namespace PTV.Developer.Clients.routeoptimization.optiflow.Model
{
    ...
    public partial class RouteOptimizationOrderCompartmentCombinationConstraint : IValidatableObject
    {
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            if (this.CompartmentCategory != null && this.CompartmentCategory.Length > 201)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for CompartmentCategory, length must be less than 201.", new [] { "CompartmentCategory" });
            }
            ...
            if (this.CompartmentCategory != null) {
                ...
                Regex regexCompartmentCategory = new Regex(@"^!?[a-zA-Z0-9_-]{1,200}$", RegexOptions.CultureInvariant);
