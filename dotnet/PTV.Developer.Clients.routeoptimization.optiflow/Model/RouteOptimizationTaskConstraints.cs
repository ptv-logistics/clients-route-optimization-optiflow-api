...
namespace PTV.Developer.Clients.routeoptimization.optiflow.Model
{
    ...
    public partial class RouteOptimizationTaskConstraints : IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="groups">A list of task groups. Tasks belonging to the same task group must be scheduled on the same route, or consecutively if they are on the same route, depending on the constraint defined in the task group..</param>
        ...
        /// </summary>
        /// <value>A list of task groups. Tasks belonging to the same task group must be scheduled on the same route, or consecutively if they are on the same route, depending on the constraint defined in the task group.</value>
