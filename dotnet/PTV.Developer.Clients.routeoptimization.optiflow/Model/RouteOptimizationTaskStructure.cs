...
namespace PTV.Developer.Clients.routeoptimization.optiflow.Model
{
    ...
    public partial class RouteOptimizationTaskStructure : IValidatableObject
    {
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            if (this.TimeSlotId != null && this.TimeSlotId.Length > 50)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for TimeSlotId, length must be less than 50.", new [] { "TimeSlotId" });
            }
            ...
            if (this.TimeSlotId != null) {
                ...
                Regex regexTimeSlotId = new Regex(@"^[a-zA-Z0-9_-]{1,50}$", RegexOptions.CultureInvariant);
