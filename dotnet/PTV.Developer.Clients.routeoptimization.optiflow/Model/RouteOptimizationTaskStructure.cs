...
namespace PTV.Developer.Clients.routeoptimization.optiflow.Model
{
    ...
    public partial class RouteOptimizationTaskStructure : IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="RouteOptimizationTaskStructure" /> class.
        /// </summary>
        /// <param name="start">The point in time when the task starts. It is recommended to provide this value for precise placement of breaks and charging in the route. Formatted according to [RFC 3339, section 5.6](https://tools.ietf.org/html/rfc3339#section-5.6). The date must not be before &#x60;1970-01-01T00:00:00+00:00&#x60; nor after &#x60;2037-12-31T23:59:59+00:00&#x60;. The date must provide an offset to UTC..</param>
        ...
        public RouteOptimizationTaskStructure(DateTimeOffset? start = default(DateTimeOffset?), string orderId = default(string), RouteOptimizationTaskType type = default(RouteOptimizationTaskType), string timeSlotId = default(string), string depotId = default(string), string compartmentId = default(string))
        {
        ...
        /// <summary>
        /// The point in time when the task starts. It is recommended to provide this value for precise placement of breaks and charging in the route. Formatted according to [RFC 3339, section 5.6](https://tools.ietf.org/html/rfc3339#section-5.6). The date must not be before &#x60;1970-01-01T00:00:00+00:00&#x60; nor after &#x60;2037-12-31T23:59:59+00:00&#x60;. The date must provide an offset to UTC.
        /// </summary>
        /// <value>The point in time when the task starts. It is recommended to provide this value for precise placement of breaks and charging in the route. Formatted according to [RFC 3339, section 5.6](https://tools.ietf.org/html/rfc3339#section-5.6). The date must not be before &#x60;1970-01-01T00:00:00+00:00&#x60; nor after &#x60;2037-12-31T23:59:59+00:00&#x60;. The date must provide an offset to UTC.</value>
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            if (this.OrderId != null && this.OrderId.Length > 200)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for OrderId, length must be less than 200.", new [] { "OrderId" });
            }
            ...
            if (this.OrderId != null) {
                ...
                Regex regexOrderId = new Regex(@"^[a-zA-Z0-9_-]{1,200}$", RegexOptions.CultureInvariant);
            ...
            if (this.TimeSlotId != null && this.TimeSlotId.Length > 200)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for TimeSlotId, length must be less than 200.", new [] { "TimeSlotId" });
            }
            ...
            if (this.TimeSlotId != null) {
                ...
                Regex regexTimeSlotId = new Regex(@"^[a-zA-Z0-9_-]{1,200}$", RegexOptions.CultureInvariant);
            ...
            if (this.DepotId != null && this.DepotId.Length > 200)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for DepotId, length must be less than 200.", new [] { "DepotId" });
            }
            ...
            if (this.DepotId != null) {
                ...
                Regex regexDepotId = new Regex(@"^[a-zA-Z0-9_-]{1,200}$", RegexOptions.CultureInvariant);
            ...
            if (this.CompartmentId != null && this.CompartmentId.Length > 200)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for CompartmentId, length must be less than 200.", new [] { "CompartmentId" });
            }
            ...
            if (this.CompartmentId != null) {
                ...
                Regex regexCompartmentId = new Regex(@"^[a-zA-Z0-9_-]{1,200}$", RegexOptions.CultureInvariant);
