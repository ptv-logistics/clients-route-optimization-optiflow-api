...
namespace PTV.Developer.Clients.routeoptimization.optiflow.Model
{
    ...
    public partial class RouteOptimizationOvertimeCost : IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="RouteOptimizationOvertimeCost" /> class.
        /// </summary>
        /// <param name="threshold">The threshold on the route duration [s] that defines when this overtime starts. (required).</param>
        /// <param name="extraPerHour">Specifies the extra cost for every hour above the threshold. If the threshold of multiple overtimes is exceeded, the extra costs per hour are added. (required).</param>
        ...
        /// </summary>
        /// <value>The threshold on the route duration [s] that defines when this overtime starts.</value>
        ...
        /// </summary>
        /// <value>Specifies the extra cost for every hour above the threshold. If the threshold of multiple overtimes is exceeded, the extra costs per hour are added.</value>
