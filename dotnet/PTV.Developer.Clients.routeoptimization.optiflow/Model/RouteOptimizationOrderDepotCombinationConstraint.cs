...
namespace PTV.Developer.Clients.routeoptimization.optiflow.Model
{
    ...
    public partial class RouteOptimizationOrderDepotCombinationConstraint : IValidatableObject
    {
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            if (this.DepotCategory != null && this.DepotCategory.Length > 51)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for DepotCategory, length must be less than 51.", new [] { "DepotCategory" });
            }
            ...
            if (this.DepotCategory != null) {
                ...
                Regex regexDepotCategory = new Regex(@"^!?[a-zA-Z0-9_-]{1,50}$", RegexOptions.CultureInvariant);
