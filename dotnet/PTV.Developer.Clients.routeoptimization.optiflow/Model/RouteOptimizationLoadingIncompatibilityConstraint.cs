...
namespace PTV.Developer.Clients.routeoptimization.optiflow.Model
{
    ...
    public partial class RouteOptimizationLoadingIncompatibilityConstraint : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RouteOptimizationLoadingIncompatibilityConstraint" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected RouteOptimizationLoadingIncompatibilityConstraint() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="RouteOptimizationLoadingIncompatibilityConstraint" /> class.
        /// </summary>
        ...
        public RouteOptimizationLoadingIncompatibilityConstraint(string loadedOrderCategory = default(string), string forbiddenOrderCategory = default(string), string vehicleCategory = default(string))
        {
            // to ensure "loadedOrderCategory" is required (not null)
            if (loadedOrderCategory == null)
            {
                throw new ArgumentNullException("loadedOrderCategory is a required property for RouteOptimizationLoadingIncompatibilityConstraint and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("forbiddenOrderCategory is a required property for RouteOptimizationLoadingIncompatibilityConstraint and cannot be null");
            }
