...
namespace PTV.Developer.Clients.routeoptimization.optiflow.Model
{
    ...
    public partial class RouteOptimizationTimeSlot : IValidatableObject
    {
        ...
        /// <param name="categories">A list of categories the time slot belongs to that can be used to describe constraints or rules..</param>
        public RouteOptimizationTimeSlot(string id = default(string), DateTimeOffset? earliestStart = default(DateTimeOffset?), DateTimeOffset? latestStart = default(DateTimeOffset?), DateTimeOffset? latestEnd = default(DateTimeOffset?), int? maximumAppointments = default(int?), double? costPerAppointment = 0D, int? preparationDuration = 0, List<string> categories = default(List<string>))
        {
        ...
        /// <summary>
        /// A list of categories the time slot belongs to that can be used to describe constraints or rules.
        /// </summary>
        /// <value>A list of categories the time slot belongs to that can be used to describe constraints or rules.</value>
