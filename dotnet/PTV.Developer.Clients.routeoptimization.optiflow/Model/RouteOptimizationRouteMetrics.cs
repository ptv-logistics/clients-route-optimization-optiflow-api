...
namespace PTV.Developer.Clients.routeoptimization.optiflow.Model
{
    ...
    public partial class RouteOptimizationRouteMetrics : IValidatableObject
    {
        ...
        /// <param name="numberOfOrders">The number of orders scheduled on the route..</param>
        ...
        /// <param name="vehicleUtilization">vehicleUtilization.</param>
        public RouteOptimizationRouteMetrics(int? numberOfStops = default(int?), int? numberOfOrders = default(int?), double? cost = default(double?), RouteOptimizationRouteCosts costs = default(RouteOptimizationRouteCosts), int? distance = default(int?), int? duration = default(int?), RouteOptimizationRouteDurations durations = default(RouteOptimizationRouteDurations), RouteOptimizationVehicleUtilization vehicleUtilization = default(RouteOptimizationVehicleUtilization))
        {
        ...
        /// </summary>
        /// <value>The number of orders scheduled on the route.</value>
        /// <example>8</example>
        [DataMember(Name = "numberOfOrders", EmitDefaultValue = true)]
        ...
        public RouteOptimizationRouteCosts Costs { get; set; }
        ...
        public RouteOptimizationRouteDurations Durations { get; set; }

        /// <summary>
        /// Gets or Sets VehicleUtilization
        /// </summary>
        [DataMember(Name = "vehicleUtilization", EmitDefaultValue = false)]
        public RouteOptimizationVehicleUtilization VehicleUtilization { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  VehicleUtilization: ").Append(VehicleUtilization).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            // NumberOfOrders (int?) minimum
            if (this.NumberOfOrders < (int?)0)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for NumberOfOrders, must be a value greater than or equal to 0.", new [] { "NumberOfOrders" });
            }
