...
namespace PTV.Developer.Clients.routeoptimization.optiflow.Model
{
    ...
    public partial class RouteOptimizationRouteMetrics : IValidatableObject
    {
        ...
        public RouteOptimizationRouteMetrics(int? numberOfStops = default(int?), int? numberOfOrders = default(int?), double? cost = default(double?), RouteOptimizationRouteCosts costs = default(RouteOptimizationRouteCosts), int? distance = default(int?), int? duration = default(int?), RouteOptimizationRouteDurations durations = default(RouteOptimizationRouteDurations))
        {
