...
namespace PTV.Developer.Clients.routeoptimization.optiflow.Model
{
    ...
    public partial class RouteOptimizationCompartment : IValidatableObject
    {
        ...
        /// <param name="maximumLoads">A list of load dimensions that describe the capacity of the compartment. For each dimension specified in this list, the sum of the values of the orders loaded in the compartment must be lower than or equal to the value of the compartment. For unspecified dimensions, the load of the compartment is assumed to be unconstrained for this dimension..</param>
        ...
        public RouteOptimizationCompartment(string id = default(string), List<RouteOptimizationLoad> maximumLoads = default(List<RouteOptimizationLoad>), RouteOptimizationCompartmentLoadingStrategy? loadingStrategy = default(RouteOptimizationCompartmentLoadingStrategy?), List<string> categories = default(List<string>))
        {
        ...
        /// </summary>
        /// <value>A list of load dimensions that describe the capacity of the compartment. For each dimension specified in this list, the sum of the values of the orders loaded in the compartment must be lower than or equal to the value of the compartment. For unspecified dimensions, the load of the compartment is assumed to be unconstrained for this dimension.</value>
