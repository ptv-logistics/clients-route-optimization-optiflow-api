...
namespace PTV.Developer.Clients.routeoptimization.optiflow.Model
{
    ...
    public partial class RouteOptimizationCombinationConstraints : IValidatableObject
    {
        ...
        /// <param name="orderDepot">A list of constraints on combinations of orders and depots..</param>
        /// <param name="depotVehicle">A list of constraints on combinations of depots and vehicles..</param>
        /// <param name="vehicleChargingStation">A list of constraints on combinations of vehicles and charging stations..</param>
        public RouteOptimizationCombinationConstraints(List<RouteOptimizationOrderCompartmentCombinationConstraint> orderCompartment = default(List<RouteOptimizationOrderCompartmentCombinationConstraint>), List<RouteOptimizationOrderVehicleCombinationConstraint> orderVehicle = default(List<RouteOptimizationOrderVehicleCombinationConstraint>), List<RouteOptimizationOrderDepotCombinationConstraint> orderDepot = default(List<RouteOptimizationOrderDepotCombinationConstraint>), List<RouteOptimizationDepotVehicleCombinationConstraint> depotVehicle = default(List<RouteOptimizationDepotVehicleCombinationConstraint>), List<RouteOptimizationVehicleChargingStationCombinationConstraint> vehicleChargingStation = default(List<RouteOptimizationVehicleChargingStationCombinationConstraint>))
        {
        ...
        /// </summary>
        /// <value>A list of constraints on combinations of orders and depots.</value>
        [DataMember(Name = "orderDepot", EmitDefaultValue = false)]
        public List<RouteOptimizationOrderDepotCombinationConstraint> OrderDepot { get; set; }
        ...
        /// </summary>
        /// <value>A list of constraints on combinations of vehicles and charging stations.</value>
        [DataMember(Name = "vehicleChargingStation", EmitDefaultValue = false)]
        public List<RouteOptimizationVehicleChargingStationCombinationConstraint> VehicleChargingStation { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  OrderDepot: ").Append(OrderDepot).Append("\n");
            sb.Append("  DepotVehicle: ").Append(DepotVehicle).Append("\n");
            sb.Append("  VehicleChargingStation: ").Append(VehicleChargingStation).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
