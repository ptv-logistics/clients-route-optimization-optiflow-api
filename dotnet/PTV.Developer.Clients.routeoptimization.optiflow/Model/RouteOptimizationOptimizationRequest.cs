...
namespace PTV.Developer.Clients.routeoptimization.optiflow.Model
{
    ...
    public partial class RouteOptimizationOptimizationRequest : IValidatableObject
    {
        ...
        /// <param name="locations">A list of locations where goods have to be picked up or delivered, layovers can be scheduled, or vehicles are located. Please note that the upper bound on the number of locations is a technical limit. Check your individual price plan or contract to see which limits apply. (required).</param>
        ...
        /// <param name="resources">A list of resources that can be assigned to vehicles. Resources are shared assets that cannot be used simultaneously by multiple vehicles. When vehicles share a resource, their routes must be scheduled such that they do not overlap in time. Please note that shared resources count as separate assets in your license allocation. The total asset count for any optimization includes the sum of routes and their distinct assigned resources. The upper bound on number of resources is a technical limit. Check your individual price plan or contract to see which limits apply..</param>
        /// <param name="depots">A list of depots where pickup orders can be delivered to or delivery orders can be picked up from. When providing pickup or delivery orders, each vehicle must reference at least 1 depot and at most 50 (limiting the depots per vehicle can be done using depot-vehicle combination constraints). When stopping at a depot, first pickup orders are unloaded. Afterwards, delivery orders can be loaded into the vehicle..</param>
        ...
        public RouteOptimizationOptimizationRequest(RouteOptimizationOptimizationSettings settings = default(RouteOptimizationOptimizationSettings), List<RouteOptimizationLocation> locations = default(List<RouteOptimizationLocation>), RouteOptimizationOrders orders = default(RouteOptimizationOrders), List<RouteOptimizationVehicle> vehicles = default(List<RouteOptimizationVehicle>), List<RouteOptimizationResource> resources = default(List<RouteOptimizationResource>), List<RouteOptimizationDepot> depots = default(List<RouteOptimizationDepot>), List<RouteOptimizationRouteStructure> routes = default(List<RouteOptimizationRouteStructure>), RouteOptimizationConstraints constraints = default(RouteOptimizationConstraints), RouteOptimizationRules rules = default(RouteOptimizationRules), RouteOptimizationOptimizationRequestMetadata metadata = default(RouteOptimizationOptimizationRequestMetadata))
        {
        ...
        /// <summary>
        /// A list of locations where goods have to be picked up or delivered, layovers can be scheduled, or vehicles are located. Please note that the upper bound on the number of locations is a technical limit. Check your individual price plan or contract to see which limits apply.
        /// </summary>
        /// <value>A list of locations where goods have to be picked up or delivered, layovers can be scheduled, or vehicles are located. Please note that the upper bound on the number of locations is a technical limit. Check your individual price plan or contract to see which limits apply.</value>
        ...
        /// A list of resources that can be assigned to vehicles. Resources are shared assets that cannot be used simultaneously by multiple vehicles. When vehicles share a resource, their routes must be scheduled such that they do not overlap in time. Please note that shared resources count as separate assets in your license allocation. The total asset count for any optimization includes the sum of routes and their distinct assigned resources. The upper bound on number of resources is a technical limit. Check your individual price plan or contract to see which limits apply.
        /// </summary>
        /// <value>A list of resources that can be assigned to vehicles. Resources are shared assets that cannot be used simultaneously by multiple vehicles. When vehicles share a resource, their routes must be scheduled such that they do not overlap in time. Please note that shared resources count as separate assets in your license allocation. The total asset count for any optimization includes the sum of routes and their distinct assigned resources. The upper bound on number of resources is a technical limit. Check your individual price plan or contract to see which limits apply.</value>
        [DataMember(Name = "resources", EmitDefaultValue = false)]
        public List<RouteOptimizationResource> Resources { get; set; }

        /// <summary>
        /// A list of depots where pickup orders can be delivered to or delivery orders can be picked up from. When providing pickup or delivery orders, each vehicle must reference at least 1 depot and at most 50 (limiting the depots per vehicle can be done using depot-vehicle combination constraints). When stopping at a depot, first pickup orders are unloaded. Afterwards, delivery orders can be loaded into the vehicle.
        /// </summary>
        /// <value>A list of depots where pickup orders can be delivered to or delivery orders can be picked up from. When providing pickup or delivery orders, each vehicle must reference at least 1 depot and at most 50 (limiting the depots per vehicle can be done using depot-vehicle combination constraints). When stopping at a depot, first pickup orders are unloaded. Afterwards, delivery orders can be loaded into the vehicle.</value>
        ...
        public RouteOptimizationOptimizationRequestMetadata Metadata { get; set; }
