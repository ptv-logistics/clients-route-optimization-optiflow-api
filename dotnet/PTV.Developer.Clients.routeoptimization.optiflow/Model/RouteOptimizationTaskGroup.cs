...
namespace PTV.Developer.Clients.routeoptimization.optiflow.Model
{
    ...
    public partial class RouteOptimizationTaskGroup : IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="RouteOptimizationTaskGroup" /> class.
        /// </summary>
        /// <param name="taskCategory">The category that defines which tasks belong to this task group. The constraint will be ignored if no task belongs to this category. (required).</param>
        ...
        /// </summary>
        /// <value>The category that defines which tasks belong to this task group. The constraint will be ignored if no task belongs to this category.</value>
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            if (this.TaskCategory != null && this.TaskCategory.Length > 200)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for TaskCategory, length must be less than 200.", new [] { "TaskCategory" });
            }
