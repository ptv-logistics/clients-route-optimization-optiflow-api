...
namespace PTV.Developer.Clients.routeoptimization.optiflow.Model
{
    ...
    public partial class RouteOptimizationVehicleEnd : IValidatableObject
    {
        ...
        public RouteOptimizationVehicleEnd(string locationId = default(string), DateTimeOffset? latestEndTime = default(DateTimeOffset?), int? duration = 0)
        {
            ...
            if (locationId == null)
            {
                throw new ArgumentNullException("locationId is a required property for RouteOptimizationVehicleEnd and cannot be null");
            }
        ...
        /// </summary>
        /// <value>The latest point in time a route assigned to the vehicle may end. This must not be earlier than the vehicle&#39;s earliest start time. When used in conjunction with a latest start time, the latest end time must not be earlier than the latest start time.  Formatted according to [RFC 3339, section 5.6](https://tools.ietf.org/html/rfc3339#section-5.6) and not before &#x60;1970-01-01T00:00:00+00:00&#x60;. The date must provide an offset to UTC. </value>
