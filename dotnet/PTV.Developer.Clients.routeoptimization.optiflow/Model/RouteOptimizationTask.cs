...
namespace PTV.Developer.Clients.routeoptimization.optiflow.Model
{
    ...
    public partial class RouteOptimizationTask : IValidatableObject
    {
        ...
        /// <param name="compartmentId">The unique identifier of the compartment that the order was loaded in or unloaded from..</param>
        ...
        /// </summary>
        /// <value>The unique identifier of the compartment that the order was loaded in or unloaded from.</value>
