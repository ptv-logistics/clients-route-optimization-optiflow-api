...
namespace PTV.Developer.Clients.routeoptimization.optiflow.Model
{
    ...
    public partial class RouteOptimizationTask : IValidatableObject
    {
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for OrderId, length must be less than 50.", new [] { "OrderId" });
            }
            ...
            if (this.OrderId != null) {
                ...
                Regex regexOrderId = new Regex(@"^[a-zA-Z0-9_-]{1,50}$", RegexOptions.CultureInvariant);
            ...
            if (this.CompartmentId != null && this.CompartmentId.Length > 50)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for CompartmentId, length must be less than 50.", new [] { "CompartmentId" });
            }
            ...
            if (this.CompartmentId != null) {
                ...
                Regex regexCompartmentId = new Regex(@"^[a-zA-Z0-9_-]{1,50}$", RegexOptions.CultureInvariant);
            ...
            if (this.DepotId != null && this.DepotId.Length > 50)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for DepotId, length must be less than 50.", new [] { "DepotId" });
            }
            ...
            if (this.DepotId != null) {
                ...
                Regex regexDepotId = new Regex(@"^[a-zA-Z0-9_-]{1,50}$", RegexOptions.CultureInvariant);
