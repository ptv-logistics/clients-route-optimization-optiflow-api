...
namespace PTV.Developer.Clients.routeoptimization.optiflow.Model
{
    ...
    public partial class RouteOptimizationTask : IValidatableObject
    {
        ...
        public RouteOptimizationTask(string orderId = default(string), RouteOptimizationTaskType? type = default(RouteOptimizationTaskType?), DateTimeOffset? start = default(DateTimeOffset?), int? duration = default(int?), DateTimeOffset? end = default(DateTimeOffset?), string compartmentId = default(string), string depotId = default(string))
        {
