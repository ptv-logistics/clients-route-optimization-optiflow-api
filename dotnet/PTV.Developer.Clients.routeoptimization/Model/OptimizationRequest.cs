...
namespace PTV.Developer.Clients.routeoptimization.Model
{
    ...
    public partial class OptimizationRequest : IEquatable<OptimizationRequest>, IValidatableObject
    {
        ...
        public OptimizationRequest(OptimizationSettings settings = default(OptimizationSettings), List<Location> locations = default(List<Location>), Orders orders = default(Orders), List<Vehicle> vehicles = default(List<Vehicle>), List<Depot> depots = default(List<Depot>), Constraints constraints = default(Constraints))
        {
            ...
            if (settings == null) {
                throw new ArgumentNullException("settings is a required property for OptimizationRequest and cannot be null");
            }
            ...
            if (orders == null) {
                throw new ArgumentNullException("orders is a required property for OptimizationRequest and cannot be null");
            }
            this.Orders = orders;
            // to ensure "vehicles" is required (not null)
            if (vehicles == null) {
                throw new ArgumentNullException("vehicles is a required property for OptimizationRequest and cannot be null");
            }
        ...
        public bool Equals(OptimizationRequest input)
        {
            ...
            return 
                ...
                (
                    this.Depots == input.Depots ||
                    this.Depots != null &&
                    input.Depots != null &&
                    this.Depots.SequenceEqual(input.Depots)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.Depots != null)
                {
                    hashCode = (hashCode * 59) + this.Depots.GetHashCode();
                }
