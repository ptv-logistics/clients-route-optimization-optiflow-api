...
export interface GetOptimizationRequestRequest {
    id: string;
    routes?: GetOptimizationRequestRoutesEnum;
}
...
export class OptimizationApi extends runtime.BaseAPI {
    ...
    async listOptimizationsRaw(requestParameters: ListOptimizationsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<RouteOptimizationOptimizationSummaries>> {
        ...
        if (requestParameters['deletionBefore'] != null) {
            queryParameters['deletionBefore'] = (requestParameters['deletionBefore'] as any).toISOString();
        }

        if (requestParameters['deletionAfter'] != null) {
            queryParameters['deletionAfter'] = (requestParameters['deletionAfter'] as any).toISOString();
        }
        ...
        if (requestParameters['optimizationIds'] != null) {
            queryParameters['optimizationIds'] = requestParameters['optimizationIds'];
        }
 ...
 * @export
 */
export const GetOptimizationRequestRoutesEnum = {
    ORIGINAL: 'ORIGINAL',
    FROM_RESULT: 'FROM_RESULT'
} as const;
export type GetOptimizationRequestRoutesEnum = typeof GetOptimizationRequestRoutesEnum[keyof typeof GetOptimizationRequestRoutesEnum];
