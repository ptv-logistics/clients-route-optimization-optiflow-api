...
import type { RouteOptimizationResultLoadedOrder } from './RouteOptimizationResultLoadedOrder';
import {
    RouteOptimizationResultLoadedOrderFromJSON,
    RouteOptimizationResultLoadedOrderFromJSONTyped,
    RouteOptimizationResultLoadedOrderToJSON,
} from './RouteOptimizationResultLoadedOrder';
...
export interface RouteOptimizationRouteStart {
     ...
     * @type {Array<RouteOptimizationResultLoadedOrder>}
     * @memberof RouteOptimizationRouteStart
     */
    loadedOrders?: Array<RouteOptimizationResultLoadedOrder>;
}
...
export function RouteOptimizationRouteStartFromJSONTyped(json: any, ignoreDiscriminator: boolean): RouteOptimizationRouteStart {
    ...
    return {
        ...
        'loadedOrders': json['loadedOrders'] == null ? undefined : ((json['loadedOrders'] as Array<any>).map(RouteOptimizationResultLoadedOrderFromJSON)),
    };
}
...
export function RouteOptimizationRouteStartToJSON(value?: RouteOptimizationRouteStart | null): any {
    ...
    return {
        ...
        'loadedOrders': value['loadedOrders'] == null ? undefined : ((value['loadedOrders'] as Array<any>).map(RouteOptimizationResultLoadedOrderToJSON)),
    };
}
