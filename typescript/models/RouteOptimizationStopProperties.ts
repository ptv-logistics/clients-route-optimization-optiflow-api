...
import type { RouteOptimizationStopTaskAggregation } from './RouteOptimizationStopTaskAggregation';
import {
    RouteOptimizationStopTaskAggregationFromJSON,
    RouteOptimizationStopTaskAggregationFromJSONTyped,
    RouteOptimizationStopTaskAggregationToJSON,
} from './RouteOptimizationStopTaskAggregation';
...
export interface RouteOptimizationStopProperties {
    ...
    /**
     * 
     * @type {RouteOptimizationStopTaskAggregation}
     * @memberof RouteOptimizationStopProperties
     */
    taskAggregation?: RouteOptimizationStopTaskAggregation;
    /**
     * 
...
export function RouteOptimizationStopPropertiesFromJSONTyped(json: any, ignoreDiscriminator: boolean): RouteOptimizationStopProperties {
    ...
    return {
        ...
        'taskAggregation': json['taskAggregation'] == null ? undefined : RouteOptimizationStopTaskAggregationFromJSON(json['taskAggregation']),
...
export function RouteOptimizationStopPropertiesToJSON(value?: RouteOptimizationStopProperties | null): any {
    ...
    return {
        ...
        'taskAggregation': RouteOptimizationStopTaskAggregationToJSON(value['taskAggregation']),
