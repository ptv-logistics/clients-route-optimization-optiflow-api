...
import type { RouteOptimizationDepotConstraints } from './RouteOptimizationDepotConstraints';
import {
    RouteOptimizationDepotConstraintsFromJSON,
    RouteOptimizationDepotConstraintsFromJSONTyped,
    RouteOptimizationDepotConstraintsToJSON,
} from './RouteOptimizationDepotConstraints';
import type { RouteOptimizationDepotCosts } from './RouteOptimizationDepotCosts';
import {
    RouteOptimizationDepotCostsFromJSON,
    RouteOptimizationDepotCostsFromJSONTyped,
    RouteOptimizationDepotCostsToJSON,
} from './RouteOptimizationDepotCosts';

/**
 * A depot where pickup orders can be delivered to or delivery orders can be picked up from. When stopping at a depot, first pickup orders are unloaded. Afterwards delivery orders can be loaded in the vehicle.
...
export interface RouteOptimizationDepot {
    ...
    /**
     * 
     * @type {RouteOptimizationDepotCosts}
     * @memberof RouteOptimizationDepot
     */
    costs?: RouteOptimizationDepotCosts;
    /**
     * 
     * @type {RouteOptimizationDepotConstraints}
     * @memberof RouteOptimizationDepot
     */
    constraints?: RouteOptimizationDepotConstraints;
}
...
export function RouteOptimizationDepotFromJSONTyped(json: any, ignoreDiscriminator: boolean): RouteOptimizationDepot {
    ...
    return {
        ...
        'costs': json['costs'] == null ? undefined : RouteOptimizationDepotCostsFromJSON(json['costs']),
        'constraints': json['constraints'] == null ? undefined : RouteOptimizationDepotConstraintsFromJSON(json['constraints']),
    };
}
...
export function RouteOptimizationDepotToJSON(value?: RouteOptimizationDepot | null): any {
    ...
    return {
        ...
        'costs': RouteOptimizationDepotCostsToJSON(value['costs']),
        'constraints': RouteOptimizationDepotConstraintsToJSON(value['constraints']),
    };
}
