...
import type { RouteOptimizationRespectedTaskSequenceScope } from './RouteOptimizationRespectedTaskSequenceScope';
import {
    RouteOptimizationRespectedTaskSequenceScopeFromJSON,
    RouteOptimizationRespectedTaskSequenceScopeFromJSONTyped,
    RouteOptimizationRespectedTaskSequenceScopeToJSON,
} from './RouteOptimizationRespectedTaskSequenceScope';
...
export interface RouteOptimizationRespectedTaskSequence {
    ...
    /**
     * 
     * @type {RouteOptimizationRespectedTaskSequenceScope}
     * @memberof RouteOptimizationRespectedTaskSequence
     */
    scope?: RouteOptimizationRespectedTaskSequenceScope;
}
...
export function RouteOptimizationRespectedTaskSequenceFromJSONTyped(json: any, ignoreDiscriminator: boolean): RouteOptimizationRespectedTaskSequence {
    ...
    return {
        ...
        'scope': json['scope'] == null ? undefined : RouteOptimizationRespectedTaskSequenceScopeFromJSON(json['scope']),
    };
}
...
export function RouteOptimizationRespectedTaskSequenceToJSON(value?: RouteOptimizationRespectedTaskSequence | null): any {
    ...
    return {
        ...
        'scope': RouteOptimizationRespectedTaskSequenceScopeToJSON(value['scope']),
    };
}
