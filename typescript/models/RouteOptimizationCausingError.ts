...
export interface RouteOptimizationCausingError {
     ...
     *   * `limit` - The limit.
     * * `ROUTE_OPTIMIZATION_TOO_MANY_ORDERS_TIMES_VEHICLES` - The request contains too many orders times vehicles.
     *   * `ordersTimesVehicles` - The number of orders times vehicles.
     *   * `limit` - The limit.
     * * `ROUTE_OPTIMIZATION_TOO_MANY_RESOURCES` - The request contains too many resources.
     *   * `resources` - The number of resources.
     *   * `limit` - The limit.
     * * `ROUTE_OPTIMIZATION_TOO_LONG_DURATION` - The duration of the request is too long.
     *   * `duration` - The duration of the request [s].
     *   * `limit` - The limit.
     * * `ROUTE_OPTIMIZATION_DAILY_OPTIMIZATION_DURATION_EXCEEDED` - The maximum allowed daily optimization duration, calculated from midnight UTC, has been exceeded. This includes actual durations of completed optimizations, the requested durations of queued or running optimizations and the current request duration.
     *   * `limit` - The maximum allowed daily optimization duration for your license.
     ...
     * * `ROUTE_OPTIMIZATION_STOP_CONCURRENCY_FORBIDDEN` - The request is not allowed to contain locations with stop concurrency.
     * * `ROUTE_OPTIMIZATION_ELECTRIC_VEHICLES_FORBIDDEN` - The request is not allowed to contain vehicles with a battery.
     * * `ROUTE_OPTIMIZATION_LOADED_ORDERS_FORBIDDEN` - The request is not allowed to contain vehicles with loaded orders.
     * 
