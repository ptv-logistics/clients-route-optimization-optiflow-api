...
import type { RouteOptimizationDepotTaskProperties } from './RouteOptimizationDepotTaskProperties';
import {
    RouteOptimizationDepotTaskPropertiesFromJSON,
    RouteOptimizationDepotTaskPropertiesFromJSONTyped,
    RouteOptimizationDepotTaskPropertiesToJSON,
} from './RouteOptimizationDepotTaskProperties';
...
export interface RouteOptimizationPickupOrder {
    ...
    /**
     * 
     * @type {RouteOptimizationDepotTaskProperties}
     * @memberof RouteOptimizationPickupOrder
     */
    delivery?: RouteOptimizationDepotTaskProperties;
    /**
     * 
...
export function RouteOptimizationPickupOrderFromJSONTyped(json: any, ignoreDiscriminator: boolean): RouteOptimizationPickupOrder {
    ...
    return {
        ...
        'delivery': json['delivery'] == null ? undefined : RouteOptimizationDepotTaskPropertiesFromJSON(json['delivery']),
...
export function RouteOptimizationPickupOrderToJSON(value?: RouteOptimizationPickupOrder | null): any {
    ...
    return {
        ...
        'delivery': RouteOptimizationDepotTaskPropertiesToJSON(value['delivery']),
