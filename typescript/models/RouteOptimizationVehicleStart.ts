...
import type { RouteOptimizationLoadedOrder } from './RouteOptimizationLoadedOrder';
import {
    RouteOptimizationLoadedOrderFromJSON,
    RouteOptimizationLoadedOrderFromJSONTyped,
    RouteOptimizationLoadedOrderToJSON,
} from './RouteOptimizationLoadedOrder';
...
export interface RouteOptimizationVehicleStart {
     ...
     * @type {Array<RouteOptimizationLoadedOrder>}
     * @memberof RouteOptimizationVehicleStart
     */
    loadedOrders?: Array<RouteOptimizationLoadedOrder>;
}
...
export function RouteOptimizationVehicleStartFromJSONTyped(json: any, ignoreDiscriminator: boolean): RouteOptimizationVehicleStart {
    ...
    return {
        ...
        'loadedOrders': json['loadedOrders'] == null ? undefined : ((json['loadedOrders'] as Array<any>).map(RouteOptimizationLoadedOrderFromJSON)),
    };
}
...
export function RouteOptimizationVehicleStartToJSON(value?: RouteOptimizationVehicleStart | null): any {
    ...
    return {
        ...
        'loadedOrders': value['loadedOrders'] == null ? undefined : ((value['loadedOrders'] as Array<any>).map(RouteOptimizationLoadedOrderToJSON)),
    };
}
