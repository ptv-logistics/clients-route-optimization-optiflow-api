...
import type { RouteOptimizationVehicleChargingStationCombinationConstraint } from './RouteOptimizationVehicleChargingStationCombinationConstraint';
import {
    RouteOptimizationVehicleChargingStationCombinationConstraintFromJSON,
    RouteOptimizationVehicleChargingStationCombinationConstraintFromJSONTyped,
    RouteOptimizationVehicleChargingStationCombinationConstraintToJSON,
} from './RouteOptimizationVehicleChargingStationCombinationConstraint';
...
export interface RouteOptimizationCombinationConstraints {
     ...
     * @type {Array<RouteOptimizationVehicleChargingStationCombinationConstraint>}
     * @memberof RouteOptimizationCombinationConstraints
     */
    vehicleChargingStation?: Array<RouteOptimizationVehicleChargingStationCombinationConstraint>;
}
...
export function RouteOptimizationCombinationConstraintsFromJSONTyped(json: any, ignoreDiscriminator: boolean): RouteOptimizationCombinationConstraints {
    ...
    return {
        ...
        'vehicleChargingStation': json['vehicleChargingStation'] == null ? undefined : ((json['vehicleChargingStation'] as Array<any>).map(RouteOptimizationVehicleChargingStationCombinationConstraintFromJSON)),
    };
}
...
export function RouteOptimizationCombinationConstraintsToJSON(value?: RouteOptimizationCombinationConstraints | null): any {
    ...
    return {
        ...
        'vehicleChargingStation': value['vehicleChargingStation'] == null ? undefined : ((value['vehicleChargingStation'] as Array<any>).map(RouteOptimizationVehicleChargingStationCombinationConstraintToJSON)),
    };
}
