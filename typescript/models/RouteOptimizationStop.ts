...
import type { RouteOptimizationCharging } from './RouteOptimizationCharging';
import {
    RouteOptimizationChargingFromJSON,
    RouteOptimizationChargingFromJSONTyped,
    RouteOptimizationChargingToJSON,
} from './RouteOptimizationCharging';
...
export interface RouteOptimizationStop {
     ...
     * @type {Array<RouteOptimizationCharging>}
     * @memberof RouteOptimizationStop
     */
    charging?: Array<RouteOptimizationCharging>;
    /**
...
export function RouteOptimizationStopFromJSONTyped(json: any, ignoreDiscriminator: boolean): RouteOptimizationStop {
    ...
    return {
        ...
        'charging': json['charging'] == null ? undefined : ((json['charging'] as Array<any>).map(RouteOptimizationChargingFromJSON)),
...
export function RouteOptimizationStopToJSON(value?: RouteOptimizationStop | null): any {
    ...
    return {
        ...
        'charging': value['charging'] == null ? undefined : ((value['charging'] as Array<any>).map(RouteOptimizationChargingToJSON)),
