...
import type { RouteOptimizationLegLoad } from './RouteOptimizationLegLoad';
import {
    RouteOptimizationLegLoadFromJSON,
    RouteOptimizationLegLoadFromJSONTyped,
    RouteOptimizationLegLoadToJSON,
} from './RouteOptimizationLegLoad';
import type { RouteOptimizationLegStateOfCharge } from './RouteOptimizationLegStateOfCharge';
import {
    RouteOptimizationLegStateOfChargeFromJSON,
    RouteOptimizationLegStateOfChargeFromJSONTyped,
    RouteOptimizationLegStateOfChargeToJSON,
} from './RouteOptimizationLegStateOfCharge';
...
export interface RouteOptimizationLeg {
     ...
     * @type {Array<RouteOptimizationLegLoad>}
     * @memberof RouteOptimizationLeg
     */
    loads?: Array<RouteOptimizationLegLoad>;
    /**
     * 
     * @type {RouteOptimizationLegStateOfCharge}
     * @memberof RouteOptimizationLeg
     */
    stateOfCharge?: RouteOptimizationLegStateOfCharge;
}
...
export function RouteOptimizationLegFromJSONTyped(json: any, ignoreDiscriminator: boolean): RouteOptimizationLeg {
    ...
    return {
        ...
        'loads': json['loads'] == null ? undefined : ((json['loads'] as Array<any>).map(RouteOptimizationLegLoadFromJSON)),
        'stateOfCharge': json['stateOfCharge'] == null ? undefined : RouteOptimizationLegStateOfChargeFromJSON(json['stateOfCharge']),
    };
}
...
export function RouteOptimizationLegToJSON(value?: RouteOptimizationLeg | null): any {
    ...
    return {
        ...
        'loads': value['loads'] == null ? undefined : ((value['loads'] as Array<any>).map(RouteOptimizationLegLoadToJSON)),
        'stateOfCharge': RouteOptimizationLegStateOfChargeToJSON(value['stateOfCharge']),
    };
}
