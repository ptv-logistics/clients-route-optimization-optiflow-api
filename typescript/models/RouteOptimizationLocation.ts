...
import type { RouteOptimizationChargingStation } from './RouteOptimizationChargingStation';
import {
    RouteOptimizationChargingStationFromJSON,
    RouteOptimizationChargingStationFromJSONTyped,
    RouteOptimizationChargingStationToJSON,
} from './RouteOptimizationChargingStation';
import type { RouteOptimizationLayoverCondition } from './RouteOptimizationLayoverCondition';
import {
    RouteOptimizationLayoverConditionFromJSON,
    RouteOptimizationLayoverConditionFromJSONTyped,
    RouteOptimizationLayoverConditionToJSON,
} from './RouteOptimizationLayoverCondition';
...
export interface RouteOptimizationLocation {
     ...
     * @type {Array<RouteOptimizationChargingStation>}
     * @memberof RouteOptimizationLocation
     */
    chargingStations?: Array<RouteOptimizationChargingStation>;
    /**
     * 
     * @type {RouteOptimizationLayoverCondition}
     * @memberof RouteOptimizationLocation
     */
    layover?: RouteOptimizationLayoverCondition;
    /**
...
export function RouteOptimizationLocationFromJSONTyped(json: any, ignoreDiscriminator: boolean): RouteOptimizationLocation {
    ...
    return {
        ...
        'chargingStations': json['chargingStations'] == null ? undefined : ((json['chargingStations'] as Array<any>).map(RouteOptimizationChargingStationFromJSON)),
        'layover': json['layover'] == null ? undefined : RouteOptimizationLayoverConditionFromJSON(json['layover']),
...
export function RouteOptimizationLocationToJSON(value?: RouteOptimizationLocation | null): any {
    ...
    return {
        ...
        'chargingStations': value['chargingStations'] == null ? undefined : ((value['chargingStations'] as Array<any>).map(RouteOptimizationChargingStationToJSON)),
        'layover': RouteOptimizationLayoverConditionToJSON(value['layover']),
