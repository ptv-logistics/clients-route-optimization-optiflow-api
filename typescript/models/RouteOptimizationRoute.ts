...
import type { RouteOptimizationRouteResource } from './RouteOptimizationRouteResource';
import {
    RouteOptimizationRouteResourceFromJSON,
    RouteOptimizationRouteResourceFromJSONTyped,
    RouteOptimizationRouteResourceToJSON,
} from './RouteOptimizationRouteResource';
...
export interface RouteOptimizationRoute {
     ...
     * @type {Array<RouteOptimizationRouteResource>}
     * @memberof RouteOptimizationRoute
     */
    resources?: Array<RouteOptimizationRouteResource>;
    /**
...
export function RouteOptimizationRouteFromJSONTyped(json: any, ignoreDiscriminator: boolean): RouteOptimizationRoute {
    ...
    return {
        ...
        'resources': json['resources'] == null ? undefined : ((json['resources'] as Array<any>).map(RouteOptimizationRouteResourceFromJSON)),
...
export function RouteOptimizationRouteToJSON(value?: RouteOptimizationRoute | null): any {
    ...
    return {
        ...
        'resources': value['resources'] == null ? undefined : ((value['resources'] as Array<any>).map(RouteOptimizationRouteResourceToJSON)),
