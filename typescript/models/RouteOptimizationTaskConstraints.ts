...
import type { RouteOptimizationTaskLoadingIncompatibilityConstraint } from './RouteOptimizationTaskLoadingIncompatibilityConstraint';
import {
    RouteOptimizationTaskLoadingIncompatibilityConstraintFromJSON,
    RouteOptimizationTaskLoadingIncompatibilityConstraintFromJSONTyped,
    RouteOptimizationTaskLoadingIncompatibilityConstraintToJSON,
} from './RouteOptimizationTaskLoadingIncompatibilityConstraint';
...
export interface RouteOptimizationTaskConstraints {
     ...
     * @type {Array<RouteOptimizationTaskLoadingIncompatibilityConstraint>}
     * @memberof RouteOptimizationTaskConstraints
     */
    loadingIncompatibilities?: Array<RouteOptimizationTaskLoadingIncompatibilityConstraint>;
}
...
export function RouteOptimizationTaskConstraintsFromJSONTyped(json: any, ignoreDiscriminator: boolean): RouteOptimizationTaskConstraints {
    ...
    return {
        ...
        'loadingIncompatibilities': json['loadingIncompatibilities'] == null ? undefined : ((json['loadingIncompatibilities'] as Array<any>).map(RouteOptimizationTaskLoadingIncompatibilityConstraintFromJSON)),
    };
}
...
export function RouteOptimizationTaskConstraintsToJSON(value?: RouteOptimizationTaskConstraints | null): any {
    ...
    return {
        ...
        'loadingIncompatibilities': value['loadingIncompatibilities'] == null ? undefined : ((value['loadingIncompatibilities'] as Array<any>).map(RouteOptimizationTaskLoadingIncompatibilityConstraintToJSON)),
    };
}
