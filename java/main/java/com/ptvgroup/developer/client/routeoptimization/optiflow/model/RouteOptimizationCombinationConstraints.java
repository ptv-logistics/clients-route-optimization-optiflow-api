...
import com.ptvgroup.developer.client.routeoptimization.optiflow.model.RouteOptimizationVehicleChargingStationCombinationConstraint;
...
/**
 * Describes constraints on combinations of entities (e.g. orders, vehicles or depots).
 */
@JsonPropertyOrder({
  ...
  RouteOptimizationCombinationConstraints.JSON_PROPERTY_VEHICLE_CHARGING_STATION
})
...
public class RouteOptimizationCombinationConstraints {
  ...
  public static final String JSON_PROPERTY_VEHICLE_CHARGING_STATION = "vehicleChargingStation";
  private List<RouteOptimizationVehicleChargingStationCombinationConstraint> vehicleChargingStation = new ArrayList<>();
  ...
  **/
  ...
  public RouteOptimizationCombinationConstraints vehicleChargingStation(List<RouteOptimizationVehicleChargingStationCombinationConstraint> vehicleChargingStation) {
    this.vehicleChargingStation = vehicleChargingStation;
    return this;
  }

  public RouteOptimizationCombinationConstraints addVehicleChargingStationItem(RouteOptimizationVehicleChargingStationCombinationConstraint vehicleChargingStationItem) {
    if (this.vehicleChargingStation == null) {
      this.vehicleChargingStation = new ArrayList<>();
    }
    this.vehicleChargingStation.add(vehicleChargingStationItem);
    return this;
  }

   /**
   * A list of constraints on combinations of vehicles and charging stations.
   * @return vehicleChargingStation
  **/
  @jakarta.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_VEHICLE_CHARGING_STATION)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public List<RouteOptimizationVehicleChargingStationCombinationConstraint> getVehicleChargingStation() {
    return vehicleChargingStation;
  }
  ...
  @JsonProperty(JSON_PROPERTY_VEHICLE_CHARGING_STATION)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setVehicleChargingStation(List<RouteOptimizationVehicleChargingStationCombinationConstraint> vehicleChargingStation) {
    this.vehicleChargingStation = vehicleChargingStation;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.orderCompartment, combinationConstraints.orderCompartment) &&
        ...
        Objects.equals(this.vehicleChargingStation, combinationConstraints.vehicleChargingStation);
  }

  @Override
  public int hashCode() {
    return Objects.hash(orderCompartment, orderVehicle, orderDepot, depotVehicle, vehicleChargingStation);
  }
  ...
  public String toString() {
    ...
    sb.append("    vehicleChargingStation: ").append(toIndentedString(vehicleChargingStation)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `vehicleChargingStation` to the URL query string
    if (getVehicleChargingStation() != null) {
      for (int i = 0; i < getVehicleChargingStation().size(); i++) {
        if (getVehicleChargingStation().get(i) != null) {
          joiner.add(getVehicleChargingStation().get(i).toUrlQueryString(String.format("%svehicleChargingStation%s%s", prefix, suffix,
          "".equals(suffix) ? "" : String.format("%s%d%s", containerPrefix, i, containerSuffix))));
        }
      }
    }
