...
public class RouteOptimizationVehicleStart {
  ...
  **/
  ...
  public RouteOptimizationVehicleStart addLoadedOrdersItem(RouteOptimizationLoadedOrder loadedOrdersItem) {
   ...
   /**
   * Orders that are already present on the vehicle when the route starts, listed in loading order. Their pickup task must be omitted from the order definition as it is planned outside the scope of this optimization. As a result, features dependent on pickup tasks - such as task constraints or stop concurrency - will not apply. Constraints independent of pickup tasks will still be enforced (e.g., maximum loads, compartments, repositioning effort, or order sequences). If there are loaded orders, the location id of the start must be defined. Note that a loaded order may remain unscheduled if it cannot satisfy constraints or if it is better in terms of cost to exclude it. In this case, the unscheduled loaded order will also not be considered for any constraints. Check your individual price plan or contract to see whether or not the request may contain loaded orders.
   * @return loadedOrders
  **/
  @jakarta.annotation.Nullable
