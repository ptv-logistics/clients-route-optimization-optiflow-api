...
import com.ptvgroup.developer.client.routeoptimization.optiflow.model.RouteOptimizationStopTaskAggregation;
...
@JsonPropertyOrder({
  ...
  RouteOptimizationStopProperties.JSON_PROPERTY_TASK_AGGREGATION,
...
public class RouteOptimizationStopProperties {
  ...
  public static final String JSON_PROPERTY_TASK_AGGREGATION = "taskAggregation";
  private RouteOptimizationStopTaskAggregation taskAggregation = RouteOptimizationStopTaskAggregation.OPTIONAL;
  ...
  **/
  ...
  public RouteOptimizationStopProperties taskAggregation(RouteOptimizationStopTaskAggregation taskAggregation) {
  ...
  **/
  @jakarta.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_TASK_AGGREGATION)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public RouteOptimizationStopTaskAggregation getTaskAggregation() {
    return taskAggregation;
  }
  ...
  @JsonProperty(JSON_PROPERTY_TASK_AGGREGATION)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setTaskAggregation(RouteOptimizationStopTaskAggregation taskAggregation) {
    this.taskAggregation = taskAggregation;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.preparationDuration, stopProperties.preparationDuration) &&
        ...
        Objects.equals(this.taskAggregation, stopProperties.taskAggregation) &&
        Objects.equals(this.concurrency, stopProperties.concurrency);
  }

  @Override
  public int hashCode() {
    return Objects.hash(preparationDuration, timeSlots, taskAggregation, concurrency);
  }
  ...
  public String toString() {
    ...
    sb.append("    taskAggregation: ").append(toIndentedString(taskAggregation)).append("\n");
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `taskAggregation` to the URL query string
    if (getTaskAggregation() != null) {
      joiner.add(String.format("%staskAggregation%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getTaskAggregation()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
