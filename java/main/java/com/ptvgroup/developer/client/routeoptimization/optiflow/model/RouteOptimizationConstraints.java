...
import com.ptvgroup.developer.client.routeoptimization.optiflow.model.RouteOptimizationBreakConstraints;
import com.ptvgroup.developer.client.routeoptimization.optiflow.model.RouteOptimizationCombinationConstraints;
import com.ptvgroup.developer.client.routeoptimization.optiflow.model.RouteOptimizationLocationConstraints;
...
@JsonPropertyOrder({
  ...
  RouteOptimizationConstraints.JSON_PROPERTY_BREAKS,
  RouteOptimizationConstraints.JSON_PROPERTY_LOCATIONS
})
...
public class RouteOptimizationConstraints {
  ...
  private RouteOptimizationBreakConstraints breaks;

  public static final String JSON_PROPERTY_LOCATIONS = "locations";
  private RouteOptimizationLocationConstraints locations;
  ...
  **/
  ...
  public RouteOptimizationConstraints breaks(RouteOptimizationBreakConstraints breaks) {
    this.breaks = breaks;
    return this;
  }
  ...
  **/
  ...
  public RouteOptimizationBreakConstraints getBreaks() {
    return breaks;
  }
  ...
  @JsonProperty(JSON_PROPERTY_BREAKS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setBreaks(RouteOptimizationBreakConstraints breaks) {
    this.breaks = breaks;
  }


  public RouteOptimizationConstraints locations(RouteOptimizationLocationConstraints locations) {
  ...
  **/
  ...
  public RouteOptimizationLocationConstraints getLocations() {
    return locations;
  }
  ...
  @JsonProperty(JSON_PROPERTY_LOCATIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setLocations(RouteOptimizationLocationConstraints locations) {
    this.locations = locations;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.combinations, constraints.combinations) &&
        ...
        Objects.equals(this.breaks, constraints.breaks) &&
        Objects.equals(this.locations, constraints.locations);
  }

  @Override
  public int hashCode() {
    return Objects.hash(combinations, orders, tasks, breaks, locations);
  }
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getLocations() != null) {
      joiner.add(getLocations().toUrlQueryString(prefix + "locations" + suffix));
    }
