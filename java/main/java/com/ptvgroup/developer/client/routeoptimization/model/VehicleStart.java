...
public class VehicleStart {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "2023-10-03T08:00Z", required = true, value = "The earliest point in time a route assigned to the vehicle may start. Formatted according to [RFC 3339, section 5.6](https://tools.ietf.org/html/rfc3339#section-5.6) and not before `1970-01-01T00:00:00+00:00`. The date must provide an offset to UTC. ")
  ...
  **/
  ...
  @ApiModelProperty(example = "2023-10-03T09:00Z", value = "The latest point in time a route assigned to the vehicle may start. Formatted according to [RFC 3339, section 5.6](https://tools.ietf.org/html/rfc3339#section-5.6) and not before `1970-01-01T00:00:00+00:00`. The date must provide an offset to UTC. ")
