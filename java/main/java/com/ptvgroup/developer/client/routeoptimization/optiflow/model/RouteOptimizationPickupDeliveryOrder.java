...
/**
 * A request to pickup and deliver an order from and to a specific location. A pickup is required if the order is not already loaded, and must not be provided if it is.
 */
@JsonPropertyOrder({
