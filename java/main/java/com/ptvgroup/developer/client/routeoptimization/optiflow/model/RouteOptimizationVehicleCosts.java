...
@JsonPropertyOrder({
  ...
  RouteOptimizationVehicleCosts.JSON_PROPERTY_UNUSED,
...
public class RouteOptimizationVehicleCosts {
  ...
  **/
  ...
  public RouteOptimizationVehicleCosts unused(Double unused) {
    this.unused = unused;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.perHour, vehicleCosts.perHour) &&
        ...
        Objects.equals(this.unused, vehicleCosts.unused) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(perHour, perKilometer, perStop, fixed, unused, overtimes, overdistances, overstops, overloads, repositioningEfforts);
  }
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `unused` to the URL query string
    if (getUnused() != null) {
      joiner.add(String.format("%sunused%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getUnused()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
