...
import com.ptvgroup.developer.client.routeoptimization.optiflow.model.RouteOptimizationAssignedResource;
...
import com.ptvgroup.developer.client.routeoptimization.optiflow.model.RouteOptimizationUnscheduledOrder;
import com.ptvgroup.developer.client.routeoptimization.optiflow.model.RouteOptimizationViolation;
...
@JsonPropertyOrder({
  ...
  RouteOptimizationOptimizationResult.JSON_PROPERTY_VIOLATIONS,
  RouteOptimizationOptimizationResult.JSON_PROPERTY_RESOURCES,
  RouteOptimizationOptimizationResult.JSON_PROPERTY_METRICS,
  RouteOptimizationOptimizationResult.JSON_PROPERTY_UNSCHEDULED_ORDERS,
...
public class RouteOptimizationOptimizationResult {
  ...
  private List<RouteOptimizationViolation> violations = new ArrayList<>();

  public static final String JSON_PROPERTY_RESOURCES = "resources";
  private List<RouteOptimizationAssignedResource> resources = new ArrayList<>();

  public static final String JSON_PROPERTY_METRICS = "metrics";
  private RouteOptimizationMetrics metrics;

  public static final String JSON_PROPERTY_UNSCHEDULED_ORDERS = "unscheduledOrders";
  private List<RouteOptimizationUnscheduledOrder> unscheduledOrders;
  ...
  **/
  ...
  public RouteOptimizationOptimizationResult violations(List<RouteOptimizationViolation> violations) {
    this.violations = violations;
    return this;
  }

  public RouteOptimizationOptimizationResult addViolationsItem(RouteOptimizationViolation violationsItem) {
   ...
   /**
   * A list of constraint violations present in the optimization result.
   * @return violations
  **/
  @jakarta.annotation.Nullable
  ...
  public List<RouteOptimizationViolation> getViolations() {
    return violations;
  }
  ...
  @JsonProperty(JSON_PROPERTY_VIOLATIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setViolations(List<RouteOptimizationViolation> violations) {
    this.violations = violations;
  }


  public RouteOptimizationOptimizationResult resources(List<RouteOptimizationAssignedResource> resources) {
    this.resources = resources;
    return this;
  }

  public RouteOptimizationOptimizationResult addResourcesItem(RouteOptimizationAssignedResource resourcesItem) {
  ...
  **/
  ...
  public List<RouteOptimizationAssignedResource> getResources() {
    return resources;
  }
  ...
  @JsonProperty(JSON_PROPERTY_RESOURCES)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResources(List<RouteOptimizationAssignedResource> resources) {
    this.resources = resources;
  }
  ...
  **/
  ...
  public RouteOptimizationOptimizationResult unscheduledOrders(List<RouteOptimizationUnscheduledOrder> unscheduledOrders) {
    this.unscheduledOrders = unscheduledOrders;
    return this;
  }

  public RouteOptimizationOptimizationResult addUnscheduledOrdersItem(RouteOptimizationUnscheduledOrder unscheduledOrdersItem) {
    if (this.unscheduledOrders == null) {
      this.unscheduledOrders = new ArrayList<>();
    }
    this.unscheduledOrders.add(unscheduledOrdersItem);
    return this;
  }
  ...
  **/
  @jakarta.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_UNSCHEDULED_ORDERS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public List<RouteOptimizationUnscheduledOrder> getUnscheduledOrders() {
    return unscheduledOrders;
  }
  ...
  @JsonProperty(JSON_PROPERTY_UNSCHEDULED_ORDERS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setUnscheduledOrders(List<RouteOptimizationUnscheduledOrder> unscheduledOrders) {
    this.unscheduledOrders = unscheduledOrders;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, optimizationResult.id) &&
        ...
        Objects.equals(this.violations, optimizationResult.violations) &&
        Objects.equals(this.resources, optimizationResult.resources) &&
        Objects.equals(this.metrics, optimizationResult.metrics) &&
        Objects.equals(this.unscheduledOrders, optimizationResult.unscheduledOrders) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, metadata, status, routes, violations, resources, metrics, unscheduledOrders, error, warnings);
  }
  ...
  public String toString() {
    ...
    sb.append("    unscheduledOrders: ").append(toIndentedString(unscheduledOrders)).append("\n");
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getViolations() != null) {
      for (int i = 0; i < getViolations().size(); i++) {
        if (getViolations().get(i) != null) {
          joiner.add(getViolations().get(i).toUrlQueryString(String.format("%sviolations%s%s", prefix, suffix,
          "".equals(suffix) ? "" : String.format("%s%d%s", containerPrefix, i, containerSuffix))));
        }
      }
    }
    ...
    // add `unscheduledOrders` to the URL query string
    if (getUnscheduledOrders() != null) {
      for (int i = 0; i < getUnscheduledOrders().size(); i++) {
        if (getUnscheduledOrders().get(i) != null) {
          joiner.add(getUnscheduledOrders().get(i).toUrlQueryString(String.format("%sunscheduledOrders%s%s", prefix, suffix,
          "".equals(suffix) ? "" : String.format("%s%d%s", containerPrefix, i, containerSuffix))));
        }
      }
    }
