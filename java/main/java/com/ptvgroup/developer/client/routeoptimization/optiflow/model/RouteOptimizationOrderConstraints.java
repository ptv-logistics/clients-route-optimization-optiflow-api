...
import com.ptvgroup.developer.client.routeoptimization.optiflow.model.RouteOptimizationOrderSchedulingIncompatibilityConstraint;
...
@JsonPropertyOrder({
  ...
  RouteOptimizationOrderConstraints.JSON_PROPERTY_SCHEDULING_INCOMPATIBILITIES
})
...
public class RouteOptimizationOrderConstraints {
  ...
  public static final String JSON_PROPERTY_SCHEDULING_INCOMPATIBILITIES = "schedulingIncompatibilities";
  private List<RouteOptimizationOrderSchedulingIncompatibilityConstraint> schedulingIncompatibilities = new ArrayList<>();
  ...
  **/
  ...
  public RouteOptimizationOrderConstraints schedulingIncompatibilities(List<RouteOptimizationOrderSchedulingIncompatibilityConstraint> schedulingIncompatibilities) {
    this.schedulingIncompatibilities = schedulingIncompatibilities;
    return this;
  }

  public RouteOptimizationOrderConstraints addSchedulingIncompatibilitiesItem(RouteOptimizationOrderSchedulingIncompatibilityConstraint schedulingIncompatibilitiesItem) {
    if (this.schedulingIncompatibilities == null) {
      this.schedulingIncompatibilities = new ArrayList<>();
    }
    this.schedulingIncompatibilities.add(schedulingIncompatibilitiesItem);
    return this;
  }
   ...
   * @return schedulingIncompatibilities
  **/
  @jakarta.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_SCHEDULING_INCOMPATIBILITIES)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public List<RouteOptimizationOrderSchedulingIncompatibilityConstraint> getSchedulingIncompatibilities() {
    return schedulingIncompatibilities;
  }
  ...
  @JsonProperty(JSON_PROPERTY_SCHEDULING_INCOMPATIBILITIES)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setSchedulingIncompatibilities(List<RouteOptimizationOrderSchedulingIncompatibilityConstraint> schedulingIncompatibilities) {
    this.schedulingIncompatibilities = schedulingIncompatibilities;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.respectedSequences, orderConstraints.respectedSequences) &&
        ...
        Objects.equals(this.schedulingIncompatibilities, orderConstraints.schedulingIncompatibilities);
  }

  @Override
  public int hashCode() {
    return Objects.hash(respectedSequences, loadingIncompatibilities, schedulingIncompatibilities);
  }
  ...
  public String toString() {
    ...
    sb.append("    schedulingIncompatibilities: ").append(toIndentedString(schedulingIncompatibilities)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `schedulingIncompatibilities` to the URL query string
    if (getSchedulingIncompatibilities() != null) {
      for (int i = 0; i < getSchedulingIncompatibilities().size(); i++) {
        if (getSchedulingIncompatibilities().get(i) != null) {
          joiner.add(getSchedulingIncompatibilities().get(i).toUrlQueryString(String.format("%sschedulingIncompatibilities%s%s", prefix, suffix,
          "".equals(suffix) ? "" : String.format("%s%d%s", containerPrefix, i, containerSuffix))));
        }
      }
    }
