...
@JsonPropertyOrder({
  ...
  RouteOptimizationTimeSlot.JSON_PROPERTY_CATEGORIES
})
...
public class RouteOptimizationTimeSlot {
  ...
  **/
  ...
  public RouteOptimizationTimeSlot categories(List<String> categories) {
    this.categories = categories;
    return this;
  }

  public RouteOptimizationTimeSlot addCategoriesItem(String categoriesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, timeSlot.id) &&
        ...
        Objects.equals(this.categories, timeSlot.categories);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, earliestStart, latestStart, latestEnd, maximumAppointments, costPerAppointment, preparationDuration, categories);
  }
