...
/**
 * Restricts how long the driver of the vehicle may work without taking a break of at least the specified duration(s). All the time spent during a route is considered working time except for waiting time and break time. Either a minimum break duration or a list of minimum break durations should be provided.
 */
@JsonPropertyOrder({
