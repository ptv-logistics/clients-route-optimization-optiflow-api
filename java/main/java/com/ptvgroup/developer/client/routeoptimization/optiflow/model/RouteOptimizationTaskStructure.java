 ...
 */
@JsonPropertyOrder({
  RouteOptimizationTaskStructure.JSON_PROPERTY_START,
...
public class RouteOptimizationTaskStructure {
  ...
  public RouteOptimizationTaskStructure start(OffsetDateTime start) {
    this.start = start;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.start, taskStructure.start) &&
        Objects.equals(this.orderId, taskStructure.orderId) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(start, orderId, type, timeSlotId, depotId, compartmentId);
  }
