...
import com.ptvgroup.developer.client.routeoptimization.optiflow.model.RouteOptimizationCharging;
...
@JsonPropertyOrder({
  ...
  RouteOptimizationStop.JSON_PROPERTY_CHARGING,
  RouteOptimizationStop.JSON_PROPERTY_BREAKS,
...
public class RouteOptimizationStop {
  ...
  private List<RouteOptimizationAppointment> appointments;

  public static final String JSON_PROPERTY_CHARGING = "charging";
  private List<RouteOptimizationCharging> charging;

  public static final String JSON_PROPERTY_BREAKS = "breaks";
  private List<RouteOptimizationBreak> breaks;
  ...
  **/
  ...
  public RouteOptimizationStop charging(List<RouteOptimizationCharging> charging) {
    this.charging = charging;
    return this;
  }

  public RouteOptimizationStop addChargingItem(RouteOptimizationCharging chargingItem) {
  ...
  **/
  ...
  public List<RouteOptimizationCharging> getCharging() {
    return charging;
  }
  ...
  @JsonProperty(JSON_PROPERTY_CHARGING)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setCharging(List<RouteOptimizationCharging> charging) {
    this.charging = charging;
  }


  public RouteOptimizationStop breaks(List<RouteOptimizationBreak> breaks) {
    this.breaks = breaks;
    return this;
  }

  public RouteOptimizationStop addBreaksItem(RouteOptimizationBreak breaksItem) {
    if (this.breaks == null) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.locationId, stop.locationId) &&
        ...
        Objects.equals(this.charging, stop.charging) &&
        Objects.equals(this.breaks, stop.breaks) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(locationId, approach, arrival, preparationDuration, appointments, charging, breaks, vehicleSlotIndex, departure);
  }
